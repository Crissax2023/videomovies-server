...
const comentarios = require('../models/comentario.model')
...
const deletePelicula = async(req,res,next) =>{
    ...
    try{
        ...
        // const comentarios = (await video.findById(peliculasId)).comentarios

         const coment = (await video.findByIdAndRemove(peliculasId)).comentarios

         for(const comentariosid of coment) {

            await comentarios.findByIdAndRemove(comentariosid)
         }
